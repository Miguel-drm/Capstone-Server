...
const TeacherDashboard = () => {
  ...
  const menuItems: MenuItem[] = [
    { icon: 'list-outline', label: 'Class List', route: '/classList' },
    { icon: 'book-outline', label: 'Insert Story', route: '/insertStory' },
    { icon: 'create-outline', label: 'Make a Test', route: '/makeTest' },
